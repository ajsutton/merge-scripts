...
tmux set-hook -g after-split-window "selectl even-vertical"
...
tmux split-window -v -f -t %0 ./show "Beku (Besu)" # "${SCRATCH}/localnet/startBesu2.sh"
...
tmux split-window -v -f -t %0 ./show "Beshouse (Besu)" # "${SCRATCH}/localnet/startBesu3.sh"

tmux split-window -h -t %7 \
  ./show "Beshouse (Lighthouse BN)"
#  $LIGHTHOUSE \
#    --spec mainnet \
#    --testnet-dir "${BEACONSPEC_DIR}" \
#    beacon_node \
